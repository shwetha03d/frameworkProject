...
<body>
				...
				<div class="nav_w3ls ml-lg-5">
					<nav>
						...
						<ul class="menu">
							...
							<li><a href="LogOut.ams">LogOut</a></li>
	...
	<div class="inner-banner-w3ls py-5" id="home">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="modal-body mt-md-2 mt-5">
				<h3 class="title-w3 mb-5 text-center text-wh font-weight-bold">Search
					Assignment</h3>
				<h3 class="col-form-label">${msg}</h3>
 ...
 -->
					...
					<div class="form-group">
						<label class="col-form-label">Pin</label> <input type="number"
							class="form-control" placeholder="Enter Assigment pin" name="pin"
							required="">
					</div>
			...
			<%-- <cs:forEach var="jspList" items="${list}" > --%>

				<tr>
					<td>${jspList.pin}</td>
					<td>${jspList.getCourse()}</td>
					<td>${jspList.getTopic()}</td>
					<td>${jspList.getDescription()}</td>
					<td>${jspList.getDeadline()}</td>
					<td>${jspList.getUploadType()}</td>
