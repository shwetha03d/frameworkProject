    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="UpdateLater.ams" method="Post">
                    <div class="form-group">
                        <label class="col-form-label">FirstName*</label>
                        <input type="text" class="form-control" value="${user.fName}" placeholder="FirstName" name="fName" required="">
                    </div>

                    <div class="form-group">
                        <label class="col-form-label">LastName</label>
                        <input type="text" class="form-control" value="${user.lName}" placeholder="LastName" name="lName" required="">
                    </div>

                    <div class="form-group">
                        <label class="col-form-label">Email*</label>
                        <input type="email" class="form-control" placeholder="xxx@gmail.com" name="email" value="${user.email}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Contact" name="mobileNo" value="${user.mobileNo}" required="">
                    </div>
